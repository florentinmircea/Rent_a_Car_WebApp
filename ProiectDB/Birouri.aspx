<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Birouri.aspx.cs" Inherits="ProiectDB.WebForm1" %>
...
&nbsp;<asp:TextBox ID="telefonb" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button_add_birou" runat="server" Text="Adauga birou nou" OnClick="Button_add_birou_Click" />
            <br />
